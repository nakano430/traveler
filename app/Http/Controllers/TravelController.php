...
class TravelController extends Controller
{
    ...
    public function password_edit(Request $request){
        ...
        return view('login.password_edit');
    }
    ...
    public function search_hotels(Request $request){
        ...
        $lower_limit = htmlspecialchars($request->input('lower_limit'), ENT_QUOTES, "UTF-8");
        $upper_limit = htmlspecialchars($request->input('upper_limit'), ENT_QUOTES, "UTF-8");
        ...
        return view('hotels.search_hotels', compact('params', 'hotel_info', 'with_room', 'user_id'));
    }
